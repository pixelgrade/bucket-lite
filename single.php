...
if (have_posts()): while (have_posts()): the_post();
	...
	<div class="wrapper">
		<div class="container container-content">
			<div class="main main-content <?php //if (wpgrade::option('blog_single_template') == 'l-sidebar-left') echo 'push4' ?>" role="main">
            ...
            <div class="article-date">
                <span class="article-date-text">Published </span><span class="publication-date"><?php the_date(); ?></span>
            </div>
						<nav class="article-control">
							<ul class="article-control-list">
								...
								next_post_link('<li class="article-control-item">%link</li>',  __('Next post', wpgrade::textdomain() ), true ); ?>
							</ul>
						</nav>
					</div>
								...
								<ul class="article-tags article-meta-list">
									<?php foreach ($categories as $cat) { ?>
										<li class="article-category-item">
											<a href="<?php echo get_category_link($cat); ?>" class="article-category-item-link">
					...
					<div class="meta-list-container meta-container_links">
						<h3 class="meta-list-title"><?php _e("Share on:", wpgrade::textdomain()); ?></h3>
		        <ul class="article-meta-list">
								<?php if ( wpgrade::option('blog_single_show_share_links') ): ?>
	                                ...
	                                <li class="article-link"><a href="https://twitter.com/intent/tweet?original_referer=<?php echo urlencode(get_permalink(get_the_ID()))?>&amp;source=tweetbutton&amp;text=<?php echo urlencode(get_the_title())?>&amp;url=<?php echo urlencode(get_permalink(get_the_ID()))?>&amp;via=<?php echo wpgrade::option( 'twitter_card_site' ) ?>" onclick="return popitup(this.href, this.title)" title="<?php _e('Share on Twitter!', wpgrade::textdomain()) ?>">Twitter</a></li>
									<?php endif; ?>
									<?php if ( wpgrade::option('blog_single_share_links_facebook') ): ?>
	                                <li class="article-link"><a href="http://www.facebook.com/sharer.php?u=<?php echo urlencode(get_permalink(get_the_ID()))?>" onclick="return popitup(this.href, this.title)" title="<?php _e('Share on Facebook!', wpgrade::textdomain()) ?>">Facebook</a></li>
									<?php endif; ?>
									<?php if ( wpgrade::option('blog_single_share_links_googleplus') ): ?>
									<li class="article-link"><a href="https://plus.google.com/share?url=<?php echo urlencode(get_permalink(get_the_ID()))?>" onclick="return popitup(this.href, this.title)" title="<?php _e('Share on Google+!', wpgrade::textdomain()) ?>">Google+</a></li>
									<?php endif; ?>
								<?php endif; ?>
		        </ul>
	          <div class="article-link to-top"><a href="#top" title="<?php _e("Jump to the top of the page", wpgrade::textdomain()); ?>">&uarr; <?php _e("Back to top", wpgrade::textdomain()); ?></a></div>
					</div>
