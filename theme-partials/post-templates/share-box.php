<div id="share-box">
	<ul class="nav">
		...
		if ( wpgrade::option('blog_single_share_links_facebook')) { ?>
			<li id="facebook" class="share-item facebook-share" data-url="<?php the_permalink() ?>" data-text="<?php the_excerpt_rss() ?>" data-title="Like"></li>
		<?php }
		if ( wpgrade::option('blog_single_share_links_googleplus')) {?>
			<li id="gplus" class="share-item gplus-share" data-url="<?php the_permalink() ?>" data-text="<?php the_excerpt_rss() ?>" data-title="+1"></li>
		<?php } ?>
		<?php if ( wpgrade::option('blog_single_share_links_pinterest')) {?>
			<li id="pinterest" class="share-item pinterest-share" data-url="<?php the_permalink() ?>" data-text="<?php the_excerpt_rss() ?>" data-title="PinIt"></li>
		<?php } ?>
