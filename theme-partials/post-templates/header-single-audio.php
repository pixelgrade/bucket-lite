<?php
/**
 * The default template for a blog post/page, requested when the post format is 'audio'.
...
<div class="grid__item  float--left  <?php echo $featured_image_width; ?>  article__featured-image">
	<a href="<?php echo esc_url( get_the_permalink() ); ?>" class="image-wrap" style="padding-top: <?php echo $image_ratio; ?>%">
