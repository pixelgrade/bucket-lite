	...
	<div class="page-content">
		<div class="page-main">
			<header class="entry__header">
				<h1 class="entry__title"><?php _e('Password ', 'bucket-lite');  the_title(); ?></h1>
				...
				<form method="post" action="<?php the_permalink() ?>" class="comment-respond">
					...
					<?php 
						if($wpgrade_private_post['error']) {
							...
							echo '<p>'.__('Please enter your password again:', 'bucket-lite').'</p>';
						} else {
							echo '<p>'.__('To view it please enter your password below:', 'bucket-lite').'</p>';
						}
					?>
					
					<div class="row">
						<div class="col-6 hand-span-6">
							<input type="password" required="required" size="20" id="pwbox-531" name="post_password" placeholder="<?php _e('Password..', 'bucket-lite') ?>"/></label><br/>
						</div>
						<div class="col-6 hand-span-6">
