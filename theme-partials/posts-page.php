	...
	<?php if (has_post_thumbnail()): ?>
		...
		<?php
			...
			if (empty($height) && empty($html_title)) {
				$height = 'data-width="'.$featured_image[1].'" '
						. 'data-height="'.$featured_image[2].'"';
			}
		?>
		...
		<div class="container container-content">
			<div class="main main-page" role="main">
				<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?>
					...
					<?php
						$hide_title = get_post_meta(get_the_ID(), wpgrade::prefix().'page_display_title', true);
					?>
