    ...
    if (is_user_logged_in()) {
        ...
        $comments_args = array(
            ...
            'fields' => apply_filters( 'comment_form_default_fields', array(
                ...
                'email' => '<p class="comment-form-email"><label for="email" class="show-on-ie8">'.__('Email', wpgrade::textdomain()).'</label><input id="email" name="email" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" type="text" placeholder="'.__('Email', wpgrade::textdomain()).'..." '. $aria_req .' /></p>' ) ),
        ...
        'fields' => apply_filters( 'comment_form_default_fields', array(
                'author' => '<p class="comment-form-author"><label for="author" class="show-on-ie8">'.__('Name', wpgrade::textdomain()).'</label><input id="author" name="author" value="' . esc_attr( $commenter['comment_author'] ) . '" type="text" placeholder="'.__('Name', wpgrade::textdomain()).'..." size="30" ' .  $aria_req . ' /></p><!--',
                'email' => '--><p class="comment-form-email"><label for="name" class="show-on-ie8">'.__('Email', wpgrade::textdomain()).'</label><input id="email" name="email" value="' . esc_attr(  $commenter['comment_author_email'] ) . '" size="30" type="text" placeholder="'.__('Email', wpgrade::textdomain()).'..." '. $aria_req .' /></p><!--',
