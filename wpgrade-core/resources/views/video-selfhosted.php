<video <?php echo ! empty($video_poster) ? 'poster="'.$video_poster.'"' : ''; ?> width="100%" height="auto" controls="controls" preload="none">
	...
	<object width="100%" height="auto" type="application/x-shockwave-flash" data="<?php echo wpgrade::coreresourceuri('general-media/flashmediaelement.swf') ?>">
		...
		<img src="<?php echo ! empty($video_poster) ? $video_poster : wpgrade::coreresourceuri('general-media/mediaelement/no-video-image.jpg'); ?>" title="No video playback capabilities" />
	</object>
</video>