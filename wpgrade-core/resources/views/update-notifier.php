	...
	<?php if ( ! (isset($_GET['wpgrade_update']) && $_GET['wpgrade_update'] == 'true')): ?>
		...
		<div id="instructions">
			...
			<div class="two-columns">
				...
				<p>
					<i><b>Important</b>: With the automatic theme update <u>any code modifications</u> to the theme's code <u>will be lost</u>, so please
				...
				<p>
					...
					<li><b>Make sure your ThemeForest/Envato Marketplace credentials have been configured.</b>
						If you haven't done so already please go to <span class="syspath-help">Theme Options &raquo; <a href="<?php echo admin_url('admin.php?page='.wpgrade::shortname().'_options&tab=8') ?>">Utilities</a></span>
						section and add your <b>ThemeForest/Envato Marketplace username</b> and <b>ThemeForest/Envato Secret API Key</b> in the corresponding fields.</li>

					<li><b>Ensure the name of the folder that contains the theme files is called "<?php echo wpgrade::shortname(); ?>"</b>. This is the default directory name,
							if you haven't modified it manually, the name of the folder on your server should be called "<?php echo wpgrade::shortname(); ?>" otherwise please change it back.</li>
				</p>
				...
				<div id="automatic-instructions">
					<div id="upgrade-instructions-style" class="automatic-update">
						<div class="auto-updater-app">
							...
							<p><b>The automatic update process will replace all your theme files.</b><p>
				...
				<div class="auto-updater-steps-ajax-failure upgrade-app-template">
					...
					<p>It is possible this is a problem with your server configuration. If you believe this to be a fluke (ie. potential problems due to high site load) feel free to restart the process.</p>
					<p><i>For assistance in diagnosing the problem please refer to the included documentation or contact support.</i></p>
					<hr/>
			...
			<div class="two-columns no-margin">
				...
				<p><b>It is recommended to manually install the update if you have done some modifications to the theme's code.</b></p>
				...
				<div id="manual-instructions" title="Manual Update Instructions">
					<div id="upgrade-instructions-style">
						...
						<p>
							...
							head over to the <strong>Downloads</strong> section in your profile and download the theme again like you
							did when you bought it.
						</p>
						<p>There are two main ways to manually install the update:</p>
						<ol>
							<li>
								<b>Install Update by uploading the theme as a new theme (recommended)</b> This is the easiest and recommended way. You just have to upload
								the updated theme zip file via the built in WordPress theme uploader as a new theme from
								<span class="syspath-help">Appearance &raquo; Themes &raquo; Install Themes &raquo; Upload</span>
								<br>
								<div class="note_box">
									<i><b>Note</b>: When activating the new theme it is possible that your menu settings are not kept for the new theme.
									If experience this issue, please go to <span class="syspath-help">Appearance &raquo; Menus &raquo; Theme Locations</span>,
									select the menu (it is still there) and press the <b>Save</b> button</i>.
								</div>
							</li>
							<li>
								<i><b>Install Update via FTP</b></i> First unzip the zipped theme file, then you can use a FTP client
								(such as <a href="http://filezilla-project.org/download.php">FileZilla</a>) and replace all the theme files with the updated version.

								<div class="note_box">
									<i><b>Note</b>: By replacing the files all code changes you have made to the files (assuming you've made any) will be lost.
										We recommend making a backup copy of the files before you replacing them. Settings you have
			...
			<p><i>For more information about manual updates, please refer to the "Updates" section of the included documentation.</i></p>
