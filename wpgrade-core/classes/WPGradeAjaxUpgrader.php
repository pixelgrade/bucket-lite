...
class WPGradeAjaxUpgrader {
	...
	protected function is_matching_themes($installed_theme, $purchased_theme) {
		return $installed_theme['Title'] == $purchased_theme->theme_name
			&& $installed_theme['Author Name'] == $purchased_theme->author_name;
	}
