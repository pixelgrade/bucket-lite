				...
				<tr>
					<td>
						...
						<?php elseif ( ! $quantites_required ) : ?>
							...
							<a href="<?php echo esc_url( $child_product['product']->add_to_cart_url() ); ?>" rel="nofollow" class="btn  btn--big  btn--add-to-cart  push--top  push--bottom"><?php echo apply_filters( 'single_add_to_cart_text', __( 'Add to cart', wpgrade::textdomain() ), $child_product['product']->product_type ); ?></a>
