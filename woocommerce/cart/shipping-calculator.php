...
<form class="shipping_calculator  soft--top" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>" method="post">

	<a href="#" class="shipping-calculator-button  btn  btn--secondary"><?php _e( 'Calculate Shipping', 'woocommerce' ); ?></a>
