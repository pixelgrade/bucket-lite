...
<form method="post" class="lost_reset_password">
    ...
    <p class="form-row"><input type="submit" class="btn" name="wc_reset_password" value="<?php echo 'lost_password' == $args['form'] ? __( 'Reset Password', 'woocommerce' ) : __( 'Save', 'woocommerce' ); ?>" /></p>
