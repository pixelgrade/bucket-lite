...
function wpgrade_warrning_about_acf(){
	echo '<div id="message" class="error"><p><b>'.
	     esc_html__("This theme requires it's own version of Advanced Custom Fields.", 'bucket-lite' ) .
		'</b></br>' .
	     esc_html__('Please uninstall the Advanced Custom Fields plugin and enable it from Theme Options -> General -> Enable Advanced Custom Fields Settings.', 'bucket-lite' ) .
		'</p></div>';
}
