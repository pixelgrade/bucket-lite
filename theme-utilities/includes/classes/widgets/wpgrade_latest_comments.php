...
class wpgrade_latest_comments extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array('classname' => 'widget--latest-comments', 'description' => __( 'The latest comments', 'bucket-lite' ) );
		parent::__construct('recent-comments', wpgrade::themename().' '.__('Latest Comments', 'bucket-lite'), $widget_ops);
	...
	function widget( $args, $instance ) {
		...
		$title = ( ! empty( $instance['title'] ) ) ? $instance['title'] : __( 'Recent Comments', 'bucket-lite' );
				...
				<article class="latest-comments__list">
					...
					<div class="media__body  latest-comments__body">
						<div class="comment__meta">
							...
							<?php endif; ?>
							<span class="comment__date"><?php _e('on', 'bucket-lite'); ?> <?php echo date( 'd M' ,strtotime($comment->comment_date)); ?></span>
						</div>
	...
	function form( $instance ) {
		...
		<p><label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Title:', 'bucket-lite' ); ?></label>
			<input class="widefat" id="<?php echo $this->get_field_id( 'title' ); ?>" name="<?php echo $this->get_field_name( 'title' ); ?>" type="text" value="<?php echo $title; ?>" /></p>

		<p><label for="<?php echo $this->get_field_id( 'number' ); ?>"><?php _e( 'Number of comments to show:', 'bucket-lite' ); ?></label>
