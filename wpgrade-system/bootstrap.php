<?php
	...
	load_theme_textdomain(wpgrade::textdomain(), wpgrade::themefilepath('wpgrade-content/languages'));
	...
	require wpgrade::themefilepath('wpgrade-content/admin-panel/bootstrap'.EXT);

	if (is_admin() && basename($_SERVER["PHP_SELF"]) != 'update-core.php') {
		require wpgrade::themefilepath('wpgrade-content/inc/upgrade-notifier'.EXT);
	}
	...
	require wpgrade::themefilepath('wpgrade-content/inc/widgets.php');
	require wpgrade::themefilepath('wpgrade-content/inc/custom-admin-login.php');
	require wpgrade::themefilepath('wpgrade-content/inc/menus.php');
	require wpgrade::themefilepath('wpgrade-content/inc/media.php');
	require wpgrade::themefilepath('wpgrade-content/inc/thumbnails.php');
