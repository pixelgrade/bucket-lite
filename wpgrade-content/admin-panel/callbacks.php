<?php
	...
	if ( ! function_exists('wpGrade_ajax_import_posts_pages'))
	{
		function wpGrade_ajax_import_posts_pages()
		{
			...
			require_once wpgrade::themefilepath('wpgrade-content/inc/import/import-demo-posts-pages'.EXT);
	...
	if( ! function_exists('wpGrade_ajax_import_widgets'))
	{
		function wpGrade_ajax_import_widgets()
		{
			...
			require_once wpgrade::themefilepath('wpgrade-content/inc/import/import-demo-widgets'.EXT);
